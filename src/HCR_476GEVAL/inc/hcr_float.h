...
#ifndef __AI_HCR_FLOAT_H__
#define __AI_HCR_FLOAT_H__
#pragma once

#include "ai_platform.h"

#define AI_HCR_FLOAT_MODEL_NAME          "hcr_float"

#define AI_HCR_FLOAT_IN_NUM       (1)
#define AI_HCR_FLOAT_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 28, 28, 1, 1, NULL), \
}
#define AI_HCR_FLOAT_IN_SIZE { \
  (28 * 28 * 1), \
}
#define AI_HCR_FLOAT_IN_1_SIZE  (28 * 28 * 1)
#define AI_HCR_FLOAT_IN_1_SIZE_BYTES  ((28 * 28 * 1) * 4)


#define AI_HCR_FLOAT_OUT_NUM      (1)
#define AI_HCR_FLOAT_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 36, 1, NULL), \
}
#define AI_HCR_FLOAT_OUT_SIZE { \
  (1 * 1 * 36), \
}
#define AI_HCR_FLOAT_OUT_1_SIZE  (1 * 1 * 36)
#define AI_HCR_FLOAT_OUT_1_SIZE_BYTES  ((1 * 1 * 36) * 4)
 ...
 * @ref ai_hcr_float_create. Both the activations memory buffer 
 ...
 * using @ref ai_hcr_float_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_HCR_FLOAT_*
 * defines into file @ref hcr_float.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_hcr_float_forward(
  ai_handle network, const ai_buffer* input);


AI_API_DECLARE_END

#endif /*__AI_HCR_FLOAT_H__*/
